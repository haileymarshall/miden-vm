...
fn permutation_test_vector() {
    ...
    assert_eq!(perm[0], Felt::new(0xf292ab67c0f14b03));
    assert_eq!(perm[1], Felt::new(0x0a32f1b37656544c));
    assert_eq!(perm[2], Felt::new(0x053c61ab895498de));
    assert_eq!(perm[3], Felt::new(0x02ff92e55b196ffb));
    assert_eq!(perm[4], Felt::new(0x58176e8f6f58cab2));
    assert_eq!(perm[5], Felt::new(0xb0aa1206e7aec0f8));
    assert_eq!(perm[6], Felt::new(0xe90c13f3dce83ca4));
    assert_eq!(perm[7], Felt::new(0xf4da15333edf39c2));
    assert_eq!(perm[8], Felt::new(0x23b701c053c2ca6c));
    assert_eq!(perm[9], Felt::new(0xd233d593dcdfbf58));
    assert_eq!(perm[10], Felt::new(0x4effa5f9516fb52e));
    assert_eq!(perm[11], Felt::new(0x0aaf4489f1f40166));
}
