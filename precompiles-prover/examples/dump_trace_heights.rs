...
/// `ECDSA_LEVELS` grid. Empty for now: none of the prior runs captured
/// proving time, and this sweep's goal is full-grid timing coverage.
/// Repopulate with the pairs below to skip re-measuring row heights on a
/// future gap-fill-only run.
const ALREADY_MEASURED: &[(usize, usize)] = &[
    // (10, 4), (10, 8), (10, 16), (10, 32), (10, 64),
    // (16, 1), (16, 10), (16, 25), (16, 50), (16, 100),
    // (50, 4), (50, 8), (50, 16), (50, 32), (50, 64),
    // (64, 1), (64, 10), (64, 25), (64, 50), (64, 100),
    // (100, 4), (100, 8), (100, 16), (100, 32), (100, 64),
    // (200, 4), (200, 8), (200, 16), (200, 32), (200, 64),
    // (256, 1), (256, 10), (256, 25), (256, 50), (256, 100),
    // (300, 4), (300, 8), (300, 16), (300, 32), (300, 64),
    // (512, 1), (512, 10), (512, 25), (512, 50), (512, 100),
    // (1024, 1), (1024, 10), (1024, 25), (1024, 50), (1024, 100),
];
